...
class afo_pdf_settings {
	...
	static $title = 'Custom Post Type Attachment ( PDF )';
	...
	function custom_pdf_attachment_post_data(){
		if(isset($_POST['option']) and sanitize_text_field($_POST['option']) == "save_custom_pdf_attachment_settings"){
			...
			if(is_array($_POST['attachment_post_types'])){
	...
	function  custom_pdf_attachment_options () {
        ...
        <?php wp_nonce_field( 'save_custom_pdf_attachment_action', 'save_custom_pdf_attachment_action_field' ); ?>
